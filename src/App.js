...
import LandingPage from "ProgrammeNET/GymApp/GymLandingPage";
import AthleteLandingPage from "ProgrammeNET/GymApp/AthleteLandingPage";
...
import TrainerLandingPage from "ProgrammeNET/GymApp/TrainerLandingPage";
import AdminLandingPage from "ProgrammeNET/GymApp/AdminLandingPage";
    ...
    return (
      <div>
        <Switch>
          ...
          />
          <Route
            path="/athletelandingpage"
            component={props => <AthleteLandingPage {...props} />}
          />
          <Route
            path="/trainerlandingpage"
            component={props => <TrainerLandingPage {...props} />}
          />
          <Route
